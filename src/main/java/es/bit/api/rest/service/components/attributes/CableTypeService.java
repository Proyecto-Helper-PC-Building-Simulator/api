...
import es.bit.api.persistence.repository.jpa.components.attributes.ICableTypeJPARepository;
import es.bit.api.rest.dto.components.attributes.CableTypeDTO;
import es.bit.api.rest.mapper.components.attributes.CableTypeMapper;
