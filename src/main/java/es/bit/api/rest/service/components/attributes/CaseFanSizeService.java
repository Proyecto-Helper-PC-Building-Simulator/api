...
import es.bit.api.persistence.repository.jpa.components.attributes.ICaseFanSizeJPARepository;
import es.bit.api.rest.dto.components.attributes.CaseFanSizeDTO;
import es.bit.api.rest.mapper.components.attributes.CaseFanSizeMapper;
