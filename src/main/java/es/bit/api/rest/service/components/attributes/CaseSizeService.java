...
import es.bit.api.persistence.repository.jpa.components.attributes.ICaseSizeJPARepository;
import es.bit.api.rest.dto.components.attributes.CaseSizeDTO;
import es.bit.api.rest.mapper.components.attributes.CaseSizeMapper;
