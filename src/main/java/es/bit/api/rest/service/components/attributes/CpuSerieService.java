...
import es.bit.api.persistence.repository.jpa.components.attributes.ICpuSerieJPARepository;
import es.bit.api.rest.dto.components.attributes.CpuSerieDTO;
import es.bit.api.rest.mapper.components.attributes.CpuSerieMapper;
