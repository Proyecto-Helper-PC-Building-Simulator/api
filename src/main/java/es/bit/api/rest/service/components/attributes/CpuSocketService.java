...
import es.bit.api.persistence.repository.jpa.components.attributes.ICpuSocketJPARepository;
import es.bit.api.rest.dto.components.attributes.CpuSocketDTO;
import es.bit.api.rest.mapper.components.attributes.CpuSocketMapper;
...
public class CpuSocketService {
    ...
    @Cacheable(value = "cpuSockets", key = "#page + '-' + #size + '-' + #sortBy + '-' + #sortDir + '-' + #filters")
