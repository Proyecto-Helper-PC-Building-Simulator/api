...
import es.bit.api.persistence.repository.jpa.components.attributes.IGpuChipsetSerieJPARepository;
import es.bit.api.rest.dto.components.attributes.GpuChipsetSerieDTO;
import es.bit.api.rest.mapper.components.attributes.GpuChipsetSerieMapper;
...
public class GpuChipsetSerieService {
    ...
    @Cacheable(value = "gpuChipsetSeries", key = "#page + '-' + #size + '-' + #sortBy + '-' + #sortDir + '-' + #filters")
