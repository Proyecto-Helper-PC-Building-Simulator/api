...
import es.bit.api.persistence.repository.jpa.components.attributes.IMotherboardFormFactorJPARepository;
import es.bit.api.rest.dto.components.attributes.MotherboardFormFactorDTO;
import es.bit.api.rest.mapper.components.attributes.MotherboardFormFactorMapper;
